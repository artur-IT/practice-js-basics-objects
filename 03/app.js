...
books.getTitle = function (isbn, lang) {
  if (typeof this[isbn] === "undefined") return null;
  //   else if (typeof this[lang] === "undefined") return null;
  else return this[isbn].title[lang];
  //   if (typeof this[isbn] != "undefined") console.log(this[(isbn, lang)]);
};

books.getTranslator = function (isbn, lang) {
  if (typeof this[isbn] === "undefined") return null;
  else if (!this[isbn].translator[lang]) return false;
